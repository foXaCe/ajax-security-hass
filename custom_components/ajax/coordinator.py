...
class AjaxDataCoordinator(AjaxArmServiceMixin, AjaxEventDispatchMixin, DataUpdateCoordinator[AjaxAccount]):
    ...
    # Event-bus emission, per-space event history and persistent
    # notifications live in ``_coordinator_events.AjaxEventDispatchMixin``.
